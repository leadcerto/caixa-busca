<div class="max-w-[1600px] mx-auto py-10 px-6 lg:px-10 space-y-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 pb-6 border-b border-slate-100">
        <div>
            <h1 class="text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight leading-none">
                Dashboard Geral
            </h1>
            <p class="text-slate-500 text-sm mt-2 font-medium">
                Visão operacional e métricas de desempenho da plataforma em tempo real.
            </p>
        </div>
        
        <!-- Live Status / Date Badge -->
        <div class="flex items-center space-x-3 self-start md:self-auto bg-white border border-slate-200/80 px-4 py-2.5 rounded-2xl shadow-sm">
            <span class="relative flex h-2.5 w-2.5">
                <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span class="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500"></span>
            </span>
            <span class="text-xs font-bold uppercase tracking-wider text-slate-500">Métricas em tempo real</span>
            <span class="text-slate-300">|</span>
            <span class="text-xs font-semibold text-slate-600">{{ now()->translatedFormat('d \d\e F, Y') }}</span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- Imóveis Ativos -->
        <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 hover:-translate-y-1 transition-all duration-300 p-6 relative overflow-hidden">
            <!-- Background Glow -->
            <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-blue-500/5 to-transparent rounded-bl-full group-hover:scale-125 transition-transform duration-500"></div>
            
            <div class="flex items-center justify-between mb-5 relative z-10">
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Imóveis Ativos</span>
            ...
            <div class="relative z-10">
                <p class="text-4xl font-extrabold text-slate-900 tracking-tight group-hover:text-[#005CA9] transition-colors">
        ...
        <!-- Total de Leads -->
        <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-amber-500/5 hover:-translate-y-1 transition-all duration-300 p-6 relative overflow-hidden">
            <!-- Background Glow -->
            <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-amber-500/5 to-transparent rounded-bl-full group-hover:scale-125 transition-transform duration-500"></div>
            
            <div class="flex items-center justify-between mb-5 relative z-10">
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Total de Leads</span>
            ...
            <div class="relative z-10">
                <p class="text-4xl font-extrabold text-slate-900 tracking-tight group-hover:text-[#F39200] transition-colors">
                    {{ number_format($this->metricas['total_leads']) }}
                </p>
                <div class="flex items-center space-x-1.5 mt-2">
                    <span class="text-[11px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded-lg shrink-0">
                        Ativos
                    </span>
        ...
        <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-emerald-500/5 hover:-translate-y-1 transition-all duration-300 p-6 relative overflow-hidden">
            <!-- Background Glow -->
            <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-emerald-500/5 to-transparent rounded-bl-full group-hover:scale-125 transition-transform duration-500"></div>
            
            <div class="flex items-center justify-between mb-5 relative z-10">
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Atendimentos</span>
            ...
            <div class="relative z-10">
                <p class="text-4xl font-extrabold text-slate-900 tracking-tight group-hover:text-emerald-600 transition-colors">
        ...
        <!-- Imobiliárias -->
        <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-purple-500/5 hover:-translate-y-1 transition-all duration-300 p-6 relative overflow-hidden">
            <!-- Background Glow -->
            <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-purple-500/5 to-transparent rounded-bl-full group-hover:scale-125 transition-transform duration-500"></div>
            
            <div class="flex items-center justify-between mb-5 relative z-10">
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Imobiliárias</span>
            ...
            <div class="relative z-10">
                <p class="text-4xl font-extrabold text-slate-900 tracking-tight group-hover:text-purple-600 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 lg:p-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400 bg-slate-50 px-2.5 py-1 rounded-lg">Performance</span>
            </div>
            
            <div class="grid grid-cols-3 gap-4 lg:gap-6">
                <div class="bg-gradient-to-b from-amber-500/[0.04] to-transparent border border-amber-500/10 rounded-2xl p-5 text-center transition-all hover:bg-amber-500/[0.06]">
                    <p class="text-3xl font-extrabold text-[#F39200]">{{ $this->metricas['leads_hoje'] }}</p>
                    <p class="text-[10px] font-extrabold uppercase text-amber-500/80 mt-2.5 tracking-wider">Hoje</p>
                </div>
                <div class="bg-slate-50/50 border border-slate-100 rounded-2xl p-5 text-center transition-all hover:bg-slate-50">
                    <p class="text-3xl font-extrabold text-slate-700">{{ $this->metricas['leads_7d'] }}</p>
                    <p class="text-[10px] font-bold uppercase text-slate-400 mt-2.5 tracking-wider">Últimos 7 dias</p>
                </div>
                <div class="bg-slate-50/50 border border-slate-100 rounded-2xl p-5 text-center transition-all hover:bg-slate-50">
                    <p class="text-3xl font-extrabold text-slate-700">{{ $this->metricas['leads_30d'] }}</p>
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 lg:p-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400 bg-slate-50 px-2.5 py-1 rounded-lg">Conversão</span>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4 lg:gap-6">
                <div class="bg-gradient-to-b from-emerald-500/[0.04] to-transparent border border-emerald-500/10 rounded-2xl p-5 text-center transition-all hover:bg-emerald-500/[0.06]">
                    <p class="text-3xl font-extrabold text-emerald-600">{{ $this->metricas['atendimentos_hoje'] }}</p>
                    <p class="text-[10px] font-extrabold uppercase text-emerald-500/80 mt-2.5 tracking-wider">Hoje</p>
                </div>
                <div class="bg-slate-50/50 border border-slate-100 rounded-2xl p-5 text-center transition-all hover:bg-slate-50">
                    <p class="text-3xl font-extrabold text-slate-700">{{ $this->metricas['atendimentos_7d'] }}</p>
                    <p class="text-[10px] font-bold uppercase text-slate-400 mt-2.5 tracking-wider">Últimos 7 dias</p>
                </div>
                <div class="bg-slate-50/50 border border-slate-100 rounded-2xl p-5 text-center transition-all hover:bg-slate-50">
                    <p class="text-3xl font-extrabold text-slate-700">{{ $this->metricas['atendimentos_30d'] }}</p>
                    <p class="text-[10px] font-bold uppercase text-slate-400 mt-2.5 tracking-wider">Últimos 30 dias</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 lg:p-8 flex flex-col min-w-0">
