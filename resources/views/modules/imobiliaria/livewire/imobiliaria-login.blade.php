<div class="min-h-screen bg-gray-50 flex items-center justify-center px-6">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-10">
            ...
            <p class="text-gray-400 text-sm mt-2 uppercase tracking-widest font-bold">Área do Parceiro</p>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 p-10 space-y-6">
            ...
            <button wire:click="login"
                    ...
                    class="w-full bg-[#F39200] hover:bg-[#E08600] text-white font-black h-14 rounded-2xl transition-all shadow-lg shadow-orange-200">
